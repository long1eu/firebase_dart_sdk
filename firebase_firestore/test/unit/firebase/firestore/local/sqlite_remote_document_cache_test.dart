...
void main() {
  ...
  test('testReadDocumentNotInCache', () => testCase.testReadDocumentNotInCache());
  test('testSetAndReadDocument', () => testCase.testSetAndReadDocument());
  test('testSetAndReadSeveralDocuments', () => testCase.testSetAndReadSeveralDocuments());
  test('testReadSeveralDocumentsIncludingMissingDocument',
      () => testCase.testReadSeveralDocumentsIncludingMissingDocument());
  test('testSetAndReadLotsOfDocuments', () => testCase.testSetAndReadLotsOfDocuments());
  test('testSetAndReadDeletedDocument', () => testCase.testSetAndReadDeletedDocument());
  test('testSetDocumentToNewValue', () => testCase.testSetDocumentToNewValue());
  test('testRemoveDocument', () => testCase.testRemoveDocument());
  test('testRemoveNonExistentDocument', () => testCase.testRemoveNonExistentDocument());
  test('testDocumentsMatchingQuery', () => testCase.testDocumentsMatchingQuery());
}
