    ...
    testCase = SpecTestCase(
      (_, String name) {
        return PersistenceTestHelpers.openSQLitePersistence(
            'firebase/firestore/spec/sqlite_spec_test_${Uri.encodeQueryComponent(name)}\_${PersistenceTestHelpers.nextSQLiteDatabaseName()}.db');
      },
      ...
      for (String key in keys) {
        ...
        if (runTest) {
          try {
            ...
            throw StateError('Spec test failure: $name $e');
          }
        } else {
