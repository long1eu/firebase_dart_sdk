...
abstract class RemoteDocumentCache {
  ...
  FutureOr<void> add(MaybeDocument maybeDocument);

  /// Removes the cached entry for the given key (no-op if no entry exists).
  FutureOr<void> remove(DocumentKey documentKey);
  ...
  FutureOr<MaybeDocument> get(DocumentKey documentKey);
  ...
  FutureOr<ImmutableSortedMap<DocumentKey, Document>>
