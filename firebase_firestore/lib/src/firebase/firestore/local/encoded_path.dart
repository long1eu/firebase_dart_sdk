...
class EncodedPath {
  ...
  static void _encodeSegment(String segment, StringBuffer result) {
    ...
    for (int i = 0; i < length; i++) {
      ...
      if (c == 0x0) {
        ...
        result..write(_escape)..write(_encodedEscape);
      } else {
        result.write(c);
      }
    }
  ...
  static void _encodeSeparator(StringBuffer result) {
    result..write(_escape)..write(_encodedSeparator);
  }
  ...
  static List<String> _decode(String path) {
    ...
    for (int start = 0; start < length;) {
      ...
      if (next == _encodedSeparator) {
        ...
        segmentBuilder..write(path.substring(start, end))..write('\0');
  ...
  static String prefixSuccessor(String path) {
    ...
    return result.toString().replaceRange(pos, pos, String.fromCharCode(c + 1));
  }
}
