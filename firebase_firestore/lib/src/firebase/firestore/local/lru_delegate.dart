...
/// interface defines the operations that the LRU garbage collector needs from the persistence
/// layer.
abstract class LruDelegate {
  ...
  /// Removes all targets that have a sequence number less than or equal to [upperBound], and are
  /// not present in the [activeTargetIds] set.
  ///
