...
enum OnlineState {
  ...
  /// failed yet. Higher-level components (e.g. [View]'s and the
  /// [EventManager]) should likely operate in online mode, waiting until they
  /// receive a  definitive OFFLINE notification before reverting to cache data,
  /// etc.
  unknown,
