...
/// Configures the behavior of [get] calls on [DocumentReference] and [Query].
/// By providing a [Source] value, these methods can be configured to fetch
...
enum Source {
  ...
  /// satisfy the [get] call, [DocumentReference.get] will return an error and
