...
class Write extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Write', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [1, 2, 6])
    ..a<$4.Document>(1, 'update', $pb.PbFieldType.OM, $4.Document.getDefault, $4.Document.create)
    ..aOS(2, 'delete')
    ..a<$5.DocumentMask>(3, 'updateMask', $pb.PbFieldType.OM, $5.DocumentMask.getDefault, $5.DocumentMask.create)
  ...
  $4.Document get update => $_getN(0);
  set update($4.Document v) { setField(1, v); }
  ...
  $5.DocumentMask get updateMask => $_getN(2);
  set updateMask($5.DocumentMask v) { setField(3, v); }
...
class DocumentTransform_FieldTransform extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentTransform.FieldTransform', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [2, 3, 4, 5, 6, 7])
    ..aOS(1, 'fieldPath')
    ...
    ..a<$4.Value>(3, 'increment', $pb.PbFieldType.OM, $4.Value.getDefault, $4.Value.create)
    ..a<$4.Value>(4, 'maximum', $pb.PbFieldType.OM, $4.Value.getDefault, $4.Value.create)
    ..a<$4.Value>(5, 'minimum', $pb.PbFieldType.OM, $4.Value.getDefault, $4.Value.create)
    ..a<$4.ArrayValue>(6, 'appendMissingElements', $pb.PbFieldType.OM, $4.ArrayValue.getDefault, $4.ArrayValue.create)
    ..a<$4.ArrayValue>(7, 'removeAllFromArray', $pb.PbFieldType.OM, $4.ArrayValue.getDefault, $4.ArrayValue.create)
    ..hasRequiredFields = false
  ;
  ...
  $4.Value get increment => $_getN(2);
  set increment($4.Value v) { setField(3, v); }
  $core.bool hasIncrement() => $_has(2);
  void clearIncrement() => clearField(3);

  $4.Value get maximum => $_getN(3);
  set maximum($4.Value v) { setField(4, v); }
  $core.bool hasMaximum() => $_has(3);
  void clearMaximum() => clearField(4);

  $4.Value get minimum => $_getN(4);
  set minimum($4.Value v) { setField(5, v); }
  $core.bool hasMinimum() => $_has(4);
  void clearMinimum() => clearField(5);

  $4.ArrayValue get appendMissingElements => $_getN(5);
  set appendMissingElements($4.ArrayValue v) { setField(6, v); }
  $core.bool hasAppendMissingElements() => $_has(5);
  void clearAppendMissingElements() => clearField(6);

  $4.ArrayValue get removeAllFromArray => $_getN(6);
  set removeAllFromArray($4.ArrayValue v) { setField(7, v); }
...
class DocumentTransform extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentTransform', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'document')
    ..pc<DocumentTransform_FieldTransform>(2, 'fieldTransforms', $pb.PbFieldType.PM,DocumentTransform_FieldTransform.create)
    ..hasRequiredFields = false
  ;
...
class WriteResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WriteResult', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..a<$0.Timestamp>(1, 'updateTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..pc<$4.Value>(2, 'transformResults', $pb.PbFieldType.PM,$4.Value.create)
    ..hasRequiredFields = false
  ;
  ...
  $core.List<$4.Value> get transformResults => $_getList(1);
}

class DocumentChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentChange', package: const $pb.PackageName('google.firestore.v1beta1'))
...
class DocumentDelete extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentDelete', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'document')
...
class DocumentRemove extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentRemove', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'document')
...
class ExistenceFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExistenceFilter', package: const $pb.PackageName('google.firestore.v1beta1'))
