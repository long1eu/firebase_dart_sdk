...
class GetDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetDocumentRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [3, 5])
    ..aOS(1, 'name')
    ..a<$5.DocumentMask>(2, 'mask', $pb.PbFieldType.OM, $5.DocumentMask.getDefault, $5.DocumentMask.create)
    ..a<$core.List<$core.int>>(3, 'transaction', $pb.PbFieldType.OY)
    ..a<$0.Timestamp>(5, 'readTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
  ...
  $5.DocumentMask get mask => $_getN(1);
  set mask($5.DocumentMask v) { setField(2, v); }
  ...
  $0.Timestamp get readTime => $_getN(3);
  set readTime($0.Timestamp v) { setField(5, v); }
...
class ListDocumentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListDocumentsRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [8, 10])
    ..aOS(1, 'parent')
    ..aOS(2, 'collectionId')
    ...
    ..aOS(4, 'pageToken')
    ..aOS(6, 'orderBy')
    ..a<$5.DocumentMask>(7, 'mask', $pb.PbFieldType.OM, $5.DocumentMask.getDefault, $5.DocumentMask.create)
    ..a<$core.List<$core.int>>(8, 'transaction', $pb.PbFieldType.OY)
    ..a<$0.Timestamp>(10, 'readTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..aOB(12, 'showMissing')
    ..hasRequiredFields = false
  ;
  ...
  $5.DocumentMask get mask => $_getN(5);
  set mask($5.DocumentMask v) { setField(7, v); }
  ...
  $0.Timestamp get readTime => $_getN(7);
  set readTime($0.Timestamp v) { setField(10, v); }
...
class ListDocumentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListDocumentsResponse', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..pc<$4.Document>(1, 'documents', $pb.PbFieldType.PM,$4.Document.create)
    ..aOS(2, 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  $core.List<$4.Document> get documents => $_getList(0);
...
class CreateDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateDocumentRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'parent')
    ..aOS(2, 'collectionId')
    ..aOS(3, 'documentId')
    ..a<$4.Document>(4, 'document', $pb.PbFieldType.OM, $4.Document.getDefault, $4.Document.create)
    ..a<$5.DocumentMask>(5, 'mask', $pb.PbFieldType.OM, $5.DocumentMask.getDefault, $5.DocumentMask.create)
    ..hasRequiredFields = false
  ;
  ...
  $4.Document get document => $_getN(3);
  set document($4.Document v) { setField(4, v); }
  $core.bool hasDocument() => $_has(3);
  void clearDocument() => clearField(4);

  $5.DocumentMask get mask => $_getN(4);
  set mask($5.DocumentMask v) { setField(5, v); }
  $core.bool hasMask() => $_has(4);
  void clearMask() => clearField(5);
}

class UpdateDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateDocumentRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..a<$4.Document>(1, 'document', $pb.PbFieldType.OM, $4.Document.getDefault, $4.Document.create)
    ..a<$5.DocumentMask>(2, 'updateMask', $pb.PbFieldType.OM, $5.DocumentMask.getDefault, $5.DocumentMask.create)
    ..a<$5.DocumentMask>(3, 'mask', $pb.PbFieldType.OM, $5.DocumentMask.getDefault, $5.DocumentMask.create)
    ..a<$5.Precondition>(4, 'currentDocument', $pb.PbFieldType.OM, $5.Precondition.getDefault, $5.Precondition.create)
    ..hasRequiredFields = false
  ;
  ...
  $5.DocumentMask get updateMask => $_getN(1);
  set updateMask($5.DocumentMask v) { setField(2, v); }
  $core.bool hasUpdateMask() => $_has(1);
  void clearUpdateMask() => clearField(2);

  $5.DocumentMask get mask => $_getN(2);
  set mask($5.DocumentMask v) { setField(3, v); }
  $core.bool hasMask() => $_has(2);
  void clearMask() => clearField(3);

  $5.Precondition get currentDocument => $_getN(3);
  set currentDocument($5.Precondition v) { setField(4, v); }
...
class DeleteDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteDocumentRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'name')
    ..a<$5.Precondition>(2, 'currentDocument', $pb.PbFieldType.OM, $5.Precondition.getDefault, $5.Precondition.create)
    ..hasRequiredFields = false
  ;
  ...
  $5.Precondition get currentDocument => $_getN(1);
  set currentDocument($5.Precondition v) { setField(2, v); }
...
class BatchGetDocumentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchGetDocumentsRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [4, 5, 7])
    ..aOS(1, 'database')
    ..pPS(2, 'documents')
    ..a<$5.DocumentMask>(3, 'mask', $pb.PbFieldType.OM, $5.DocumentMask.getDefault, $5.DocumentMask.create)
    ..a<$core.List<$core.int>>(4, 'transaction', $pb.PbFieldType.OY)
    ..a<$5.TransactionOptions>(5, 'newTransaction', $pb.PbFieldType.OM, $5.TransactionOptions.getDefault, $5.TransactionOptions.create)
    ..a<$0.Timestamp>(7, 'readTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  $5.TransactionOptions get newTransaction => $_getN(4);
  set newTransaction($5.TransactionOptions v) { setField(5, v); }
  $core.bool hasNewTransaction() => $_has(4);
  void clearNewTransaction() => clearField(5);

  $0.Timestamp get readTime => $_getN(5);
  set readTime($0.Timestamp v) { setField(7, v); }
...
class BatchGetDocumentsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchGetDocumentsResponse', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [1, 2])
    ..a<$4.Document>(1, 'found', $pb.PbFieldType.OM, $4.Document.getDefault, $4.Document.create)
    ..aOS(2, 'missing')
    ..a<$core.List<$core.int>>(3, 'transaction', $pb.PbFieldType.OY)
    ..a<$0.Timestamp>(4, 'readTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  $4.Document get found => $_getN(0);
  set found($4.Document v) { setField(1, v); }
  ...
  $0.Timestamp get readTime => $_getN(3);
  set readTime($0.Timestamp v) { setField(4, v); }
  $core.bool hasReadTime() => $_has(3);
  void clearReadTime() => clearField(4);
}

class BeginTransactionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BeginTransactionRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'database')
    ..a<$5.TransactionOptions>(2, 'options', $pb.PbFieldType.OM, $5.TransactionOptions.getDefault, $5.TransactionOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  $5.TransactionOptions get options => $_getN(1);
  set options($5.TransactionOptions v) { setField(2, v); }
  $core.bool hasOptions() => $_has(1);
  void clearOptions() => clearField(2);
}

class BeginTransactionResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BeginTransactionResponse', package: const $pb.PackageName('google.firestore.v1beta1'))
...
class CommitRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CommitRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'database')
    ..pc<$6.Write>(2, 'writes', $pb.PbFieldType.PM,$6.Write.create)
    ..a<$core.List<$core.int>>(3, 'transaction', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  $core.List<$6.Write> get writes => $_getList(1);
...
class CommitResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CommitResponse', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..pc<$6.WriteResult>(1, 'writeResults', $pb.PbFieldType.PM,$6.WriteResult.create)
    ..a<$0.Timestamp>(2, 'commitTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  $core.List<$6.WriteResult> get writeResults => $_getList(0);

  $0.Timestamp get commitTime => $_getN(1);
  set commitTime($0.Timestamp v) { setField(2, v); }
  $core.bool hasCommitTime() => $_has(1);
  void clearCommitTime() => clearField(2);
}

class RollbackRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RollbackRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'database')
...
class RunQueryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RunQueryRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [2])
    ..oo(1, [5, 6, 7])
    ..aOS(1, 'parent')
    ..a<$7.StructuredQuery>(2, 'structuredQuery', $pb.PbFieldType.OM, $7.StructuredQuery.getDefault, $7.StructuredQuery.create)
    ..a<$core.List<$core.int>>(5, 'transaction', $pb.PbFieldType.OY)
    ..a<$5.TransactionOptions>(6, 'newTransaction', $pb.PbFieldType.OM, $5.TransactionOptions.getDefault, $5.TransactionOptions.create)
    ..a<$0.Timestamp>(7, 'readTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  $7.StructuredQuery get structuredQuery => $_getN(1);
  set structuredQuery($7.StructuredQuery v) { setField(2, v); }
  ...
  $5.TransactionOptions get newTransaction => $_getN(3);
  set newTransaction($5.TransactionOptions v) { setField(6, v); }
  $core.bool hasNewTransaction() => $_has(3);
  void clearNewTransaction() => clearField(6);

  $0.Timestamp get readTime => $_getN(4);
  set readTime($0.Timestamp v) { setField(7, v); }
...
class RunQueryResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RunQueryResponse', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..a<$4.Document>(1, 'document', $pb.PbFieldType.OM, $4.Document.getDefault, $4.Document.create)
    ..a<$core.List<$core.int>>(2, 'transaction', $pb.PbFieldType.OY)
    ..a<$0.Timestamp>(3, 'readTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
  ...
  $0.Timestamp get readTime => $_getN(2);
  set readTime($0.Timestamp v) { setField(3, v); }
...
class WriteRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WriteRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'database')
    ..aOS(2, 'streamId')
    ..pc<$6.Write>(3, 'writes', $pb.PbFieldType.PM,$6.Write.create)
    ..a<$core.List<$core.int>>(4, 'streamToken', $pb.PbFieldType.OY)
    ..m<$core.String, $core.String>(5, 'labels', 'WriteRequest.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.firestore.v1beta1'))
    ..hasRequiredFields = false
  ;
  ...
  $core.List<$6.Write> get writes => $_getList(2);
...
class WriteResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WriteResponse', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'streamId')
    ..a<$core.List<$core.int>>(2, 'streamToken', $pb.PbFieldType.OY)
    ..pc<$6.WriteResult>(3, 'writeResults', $pb.PbFieldType.PM,$6.WriteResult.create)
    ..a<$0.Timestamp>(4, 'commitTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  $core.List<$6.WriteResult> get writeResults => $_getList(2);
...
class ListenRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListenRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [2, 3])
    ..aOS(1, 'database')
    ..a<Target>(2, 'addTarget', $pb.PbFieldType.OM, Target.getDefault, Target.create)
    ..a<$core.int>(3, 'removeTarget', $pb.PbFieldType.O3)
    ..m<$core.String, $core.String>(4, 'labels', 'ListenRequest.LabelsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OS, null, null, null , const $pb.PackageName('google.firestore.v1beta1'))
    ..hasRequiredFields = false
  ;
...
class ListenResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListenResponse', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [2, 3, 4, 5, 6])
    ..a<TargetChange>(2, 'targetChange', $pb.PbFieldType.OM, TargetChange.getDefault, TargetChange.create)
    ..a<$6.DocumentChange>(3, 'documentChange', $pb.PbFieldType.OM, $6.DocumentChange.getDefault, $6.DocumentChange.create)
    ..a<$6.DocumentDelete>(4, 'documentDelete', $pb.PbFieldType.OM, $6.DocumentDelete.getDefault, $6.DocumentDelete.create)
    ..a<$6.ExistenceFilter>(5, 'filter', $pb.PbFieldType.OM, $6.ExistenceFilter.getDefault, $6.ExistenceFilter.create)
    ..a<$6.DocumentRemove>(6, 'documentRemove', $pb.PbFieldType.OM, $6.DocumentRemove.getDefault, $6.DocumentRemove.create)
    ..hasRequiredFields = false
  ;
  ...
  $6.DocumentChange get documentChange => $_getN(1);
  set documentChange($6.DocumentChange v) { setField(3, v); }
  $core.bool hasDocumentChange() => $_has(1);
  void clearDocumentChange() => clearField(3);

  $6.DocumentDelete get documentDelete => $_getN(2);
  set documentDelete($6.DocumentDelete v) { setField(4, v); }
  $core.bool hasDocumentDelete() => $_has(2);
  void clearDocumentDelete() => clearField(4);

  $6.ExistenceFilter get filter => $_getN(3);
  set filter($6.ExistenceFilter v) { setField(5, v); }
  $core.bool hasFilter() => $_has(3);
  void clearFilter() => clearField(5);

  $6.DocumentRemove get documentRemove => $_getN(4);
  set documentRemove($6.DocumentRemove v) { setField(6, v); }
...
class Target_DocumentsTarget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Target.DocumentsTarget', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..pPS(2, 'documents')
    ..hasRequiredFields = false
  ;
...
class Target_QueryTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Target.QueryTarget', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [2])
    ..aOS(1, 'parent')
    ..a<$7.StructuredQuery>(2, 'structuredQuery', $pb.PbFieldType.OM, $7.StructuredQuery.getDefault, $7.StructuredQuery.create)
    ..hasRequiredFields = false
...
class Target extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Target', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..oo(0, [2, 3])
    ..oo(1, [4, 11])
    ...
    ..aOB(6, 'once')
    ..a<$0.Timestamp>(11, 'readTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  $0.Timestamp get readTime => $_getN(5);
  set readTime($0.Timestamp v) { setField(11, v); }
  $core.bool hasReadTime() => $_has(5);
  void clearReadTime() => clearField(11);
}

class TargetChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TargetChange', package: const $pb.PackageName('google.firestore.v1beta1'))
    ...
    ..a<$8.Status>(3, 'cause', $pb.PbFieldType.OM, $8.Status.getDefault, $8.Status.create)
    ..a<$core.List<$core.int>>(4, 'resumeToken', $pb.PbFieldType.OY)
    ..a<$0.Timestamp>(6, 'readTime', $pb.PbFieldType.OM, $0.Timestamp.getDefault, $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  set cause($8.Status v) { setField(3, v); }
  ...
  $0.Timestamp get readTime => $_getN(4);
  set readTime($0.Timestamp v) { setField(6, v); }
  $core.bool hasReadTime() => $_has(4);
  void clearReadTime() => clearField(6);
}

class ListCollectionIdsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListCollectionIdsRequest', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..aOS(1, 'parent')
...
class ListCollectionIdsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListCollectionIdsResponse', package: const $pb.PackageName('google.firestore.v1beta1'))
    ..pPS(1, 'collectionIds')
    ..aOS(2, 'nextPageToken')
    ..hasRequiredFields = false
  ;
...
class FirestoreApi {
  ...
  $async.Future<$4.Document> getDocument($pb.ClientContext ctx, GetDocumentRequest request) {
    var emptyResponse = $4.Document();
    return _client.invoke<$4.Document>(ctx, 'Firestore', 'GetDocument', request, emptyResponse);
  }
  $async.Future<ListDocumentsResponse> listDocuments($pb.ClientContext ctx, ListDocumentsRequest request) {
  ...
  $async.Future<$4.Document> createDocument($pb.ClientContext ctx, CreateDocumentRequest request) {
    var emptyResponse = $4.Document();
    return _client.invoke<$4.Document>(ctx, 'Firestore', 'CreateDocument', request, emptyResponse);
  }
  $async.Future<$4.Document> updateDocument($pb.ClientContext ctx, UpdateDocumentRequest request) {
    var emptyResponse = $4.Document();
    return _client.invoke<$4.Document>(ctx, 'Firestore', 'UpdateDocument', request, emptyResponse);
  }
  $async.Future<$9.Empty> deleteDocument($pb.ClientContext ctx, DeleteDocumentRequest request) {
    var emptyResponse = $9.Empty();
    return _client.invoke<$9.Empty>(ctx, 'Firestore', 'DeleteDocument', request, emptyResponse);
  }
  $async.Future<BatchGetDocumentsResponse> batchGetDocuments($pb.ClientContext ctx, BatchGetDocumentsRequest request) {
  ...
  $async.Future<$9.Empty> rollback($pb.ClientContext ctx, RollbackRequest request) {
    var emptyResponse = $9.Empty();
    return _client.invoke<$9.Empty>(ctx, 'Firestore', 'Rollback', request, emptyResponse);
  }
  ...
  $async.Future<ListenResponse> listen($pb.ClientContext ctx, ListenRequest request) {
    var emptyResponse = ListenResponse();
    return _client.invoke<ListenResponse>(ctx, 'Firestore', 'Listen', request, emptyResponse);
  }
  $async.Future<ListCollectionIdsResponse> listCollectionIds($pb.ClientContext ctx, ListCollectionIdsRequest request) {
