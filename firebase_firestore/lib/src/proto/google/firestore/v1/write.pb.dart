...
class Write extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Write', package: const $pb.PackageName('google.firestore.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 6])
    ..aOM<$1.Document>(1, 'update', subBuilder: $1.Document.create)
    ..aOS(2, 'delete')
    ..aOM<$7.DocumentMask>(3, 'updateMask', subBuilder: $7.DocumentMask.create)
    ..aOM<$7.Precondition>(4, 'currentDocument', subBuilder: $7.Precondition.create)
    ..aOM<DocumentTransform>(6, 'transform', subBuilder: DocumentTransform.create)
  ...
  @$pb.TagNumber(3)
  $7.DocumentMask get updateMask => $_getN(2);
  @$pb.TagNumber(3)
  set updateMask($7.DocumentMask v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUpdateMask() => $_has(2);
  @$pb.TagNumber(3)
  void clearUpdateMask() => clearField(3);
  @$pb.TagNumber(3)
  $7.DocumentMask ensureUpdateMask() => $_ensure(2);
...
class DocumentTransform_FieldTransform extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentTransform.FieldTransform', package: const $pb.PackageName('google.firestore.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5, 6, 7])
    ..aOS(1, 'fieldPath')
    ..e<DocumentTransform_FieldTransform_ServerValue>(2, 'setToServerValue', $pb.PbFieldType.OE, defaultOrMaker: DocumentTransform_FieldTransform_ServerValue.SERVER_VALUE_UNSPECIFIED, valueOf: DocumentTransform_FieldTransform_ServerValue.valueOf, enumValues: DocumentTransform_FieldTransform_ServerValue.values)
    ..aOM<$1.Value>(3, 'increment', subBuilder: $1.Value.create)
    ..aOM<$1.Value>(4, 'maximum', subBuilder: $1.Value.create)
    ..aOM<$1.Value>(5, 'minimum', subBuilder: $1.Value.create)
    ..aOM<$1.ArrayValue>(6, 'appendMissingElements', subBuilder: $1.ArrayValue.create)
    ..aOM<$1.ArrayValue>(7, 'removeAllFromArray', subBuilder: $1.ArrayValue.create)
    ..hasRequiredFields = false
  ;
...
class DocumentTransform extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentTransform', package: const $pb.PackageName('google.firestore.v1'), createEmptyInstance: create)
    ..aOS(1, 'document')
    ..pc<DocumentTransform_FieldTransform>(2, 'fieldTransforms', $pb.PbFieldType.PM, subBuilder: DocumentTransform_FieldTransform.create)
    ..hasRequiredFields = false
  ;
...
class WriteResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WriteResult', package: const $pb.PackageName('google.firestore.v1'), createEmptyInstance: create)
    ..aOM<$4.Timestamp>(1, 'updateTime', subBuilder: $4.Timestamp.create)
    ..pc<$1.Value>(2, 'transformResults', $pb.PbFieldType.PM, subBuilder: $1.Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4.Timestamp get updateTime => $_getN(0);
  @$pb.TagNumber(1)
  set updateTime($4.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdateTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdateTime() => clearField(1);
  @$pb.TagNumber(1)
  $4.Timestamp ensureUpdateTime() => $_ensure(0);
...
class DocumentChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentChange', package: const $pb.PackageName('google.firestore.v1'), createEmptyInstance: create)
...
class DocumentDelete extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentDelete', package: const $pb.PackageName('google.firestore.v1'), createEmptyInstance: create)
    ..aOS(1, 'document')
...
class DocumentRemove extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DocumentRemove', package: const $pb.PackageName('google.firestore.v1'), createEmptyInstance: create)
    ..aOS(1, 'document')
...
class ExistenceFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExistenceFilter', package: const $pb.PackageName('google.firestore.v1'), createEmptyInstance: create)
