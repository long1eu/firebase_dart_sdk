...
class Status extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Status', package: const $pb.PackageName('google.rpc'))
    ..a<int>(1, 'code', $pb.PbFieldType.O3)
    ..aOS(2, 'message')
    ..pp<$0.Any>(3, 'details', $pb.PbFieldType.PM, $0.Any.$checkItem, $0.Any.create)
  ...
  static void $checkItem(Status v) {
    if (v is! Status) $pb.checkItemFailed(v, _i.messageName);
  }
