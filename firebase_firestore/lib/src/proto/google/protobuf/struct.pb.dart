...
class Struct_FieldsEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Struct.FieldsEntry', package: const $pb.PackageName('google.protobuf'))
    ..aOS(1, 'key')
  ...
  Struct_FieldsEntry copyWith(void Function(Struct_FieldsEntry) updates) => super.copyWith((message) => updates(message as Struct_FieldsEntry));
  ...
  static Struct_FieldsEntry getDefault() => _defaultInstance ??= create()..freeze();
  static Struct_FieldsEntry _defaultInstance;
  static void $checkItem(Struct_FieldsEntry v) {
    if (v is! Struct_FieldsEntry) $pb.checkItemFailed(v, _i.messageName);
  }
...
class Struct extends $pb.GeneratedMessage {
  ...
  static void $checkItem(Struct v) {
    if (v is! Struct) $pb.checkItemFailed(v, _i.messageName);
  }
...
class ListValue extends $pb.GeneratedMessage {
  ...
  static void $checkItem(ListValue v) {
    if (v is! ListValue) $pb.checkItemFailed(v, _i.messageName);
  }
