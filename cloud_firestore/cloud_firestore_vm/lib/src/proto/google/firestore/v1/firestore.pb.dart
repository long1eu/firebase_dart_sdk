...
class UpdateDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateDocumentRequest',
    ...
    ..aOM<$7.Precondition>(4, 'currentDocument',
        subBuilder: $7.Precondition.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set updateMask($7.DocumentMask v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set currentDocument($7.Precondition v) {
    setField(4, v);
  }
...
class DeleteDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteDocumentRequest',
      ...
      createEmptyInstance: create)
    ..aOS(1, 'name')
    ..aOM<$7.Precondition>(2, 'currentDocument',
        subBuilder: $7.Precondition.create)
    ..hasRequiredFields = false;
...
class BatchGetDocumentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchGetDocumentsRequest',
    ...
    ..aOM<$7.TransactionOptions>(5, 'newTransaction',
        subBuilder: $7.TransactionOptions.create)
  ...
  @$pb.TagNumber(5)
  set newTransaction($7.TransactionOptions v) {
    setField(5, v);
  }
...
class BeginTransactionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BeginTransactionRequest',
      ...
      createEmptyInstance: create)
    ..aOS(1, 'database')
    ..aOM<$7.TransactionOptions>(2, 'options',
        subBuilder: $7.TransactionOptions.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set options($7.TransactionOptions v) {
    setField(2, v);
  }
...
class CommitResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CommitResponse',
      package: const $pb.PackageName('google.firestore.v1'),
      createEmptyInstance: create)
    ..pc<$8.WriteResult>(1, 'writeResults', $pb.PbFieldType.PM,
        subBuilder: $8.WriteResult.create)
...
class RunQueryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RunQueryRequest',
    ...
    ..oo(1, [5, 6, 7])
    ..aOS(1, 'parent')
    ..aOM<$11.StructuredQuery>(2, 'structuredQuery',
        subBuilder: $11.StructuredQuery.create)
    ..a<$core.List<$core.int>>(5, 'transaction', $pb.PbFieldType.OY)
    ..aOM<$7.TransactionOptions>(6, 'newTransaction',
        subBuilder: $7.TransactionOptions.create)
    ..aOM<$4.Timestamp>(7, 'readTime', subBuilder: $4.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set structuredQuery($11.StructuredQuery v) {
    setField(2, v);
  }
...
class WriteResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WriteResponse',
    ...
    ..pc<$8.WriteResult>(3, 'writeResults', $pb.PbFieldType.PM,
        subBuilder: $8.WriteResult.create)
...
class ListenResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListenResponse',
    ...
    ..aOM<$8.DocumentChange>(3, 'documentChange',
        subBuilder: $8.DocumentChange.create)
    ..aOM<$8.DocumentDelete>(4, 'documentDelete',
        subBuilder: $8.DocumentDelete.create)
    ..aOM<$8.ExistenceFilter>(5, 'filter',
        subBuilder: $8.ExistenceFilter.create)
    ..aOM<$8.DocumentRemove>(6, 'documentRemove',
        subBuilder: $8.DocumentRemove.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  set documentChange($8.DocumentChange v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(4)
  set documentDelete($8.DocumentDelete v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set filter($8.ExistenceFilter v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(6)
  set documentRemove($8.DocumentRemove v) {
    setField(6, v);
  }
