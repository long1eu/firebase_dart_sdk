...
const DocumentTransform$json = const {
  ...
  '2': const [
    ...
    const {'1': 'field_transforms', '3': 2, '4': 3, '5': 11, '6': '.google.firestore.v1.DocumentTransform.FieldTransform', '10': 'fieldTransforms'},
  ],
...
const DocumentTransform_FieldTransform$json = const {
  ...
  '2': const [
    ...
    const {'1': 'set_to_server_value', '3': 2, '4': 1, '5': 14, '6': '.google.firestore.v1.DocumentTransform.FieldTransform.ServerValue', '9': 0, '10': 'setToServerValue'},
    const {'1': 'increment', '3': 3, '4': 1, '5': 11, '6': '.google.firestore.v1.Value', '9': 0, '10': 'increment'},
    const {'1': 'maximum', '3': 4, '4': 1, '5': 11, '6': '.google.firestore.v1.Value', '9': 0, '10': 'maximum'},
    const {'1': 'minimum', '3': 5, '4': 1, '5': 11, '6': '.google.firestore.v1.Value', '9': 0, '10': 'minimum'},
    const {'1': 'append_missing_elements', '3': 6, '4': 1, '5': 11, '6': '.google.firestore.v1.ArrayValue', '9': 0, '10': 'appendMissingElements'},
    const {'1': 'remove_all_from_array', '3': 7, '4': 1, '5': 11, '6': '.google.firestore.v1.ArrayValue', '9': 0, '10': 'removeAllFromArray'},
  ],
...
const WriteResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'transform_results', '3': 2, '4': 3, '5': 11, '6': '.google.firestore.v1.Value', '10': 'transformResults'},
  ],
};
