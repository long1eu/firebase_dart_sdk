...
const Document$json = const {
  ...
  '2': const [
    ...
    const {'1': 'fields', '3': 2, '4': 3, '5': 11, '6': '.google.firestore.v1.Document.FieldsEntry', '10': 'fields'},
...
const Document_FieldsEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.firestore.v1.Value', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const Value$json = const {
  ...
  '2': const [
    ...
    const {'1': 'array_value', '3': 9, '4': 1, '5': 11, '6': '.google.firestore.v1.ArrayValue', '9': 0, '10': 'arrayValue'},
    const {'1': 'map_value', '3': 6, '4': 1, '5': 11, '6': '.google.firestore.v1.MapValue', '9': 0, '10': 'mapValue'},
  ],
  '8': const [
    const {'1': 'value_type'},
  ],
