...
class MutationQueue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MutationQueue',
  ...
  factory MutationQueue.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MutationQueue.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  MutationQueue clone() => MutationQueue()..mergeFromMessage(this);
  MutationQueue copyWith(void Function(MutationQueue) updates) =>
      super.copyWith((message) => updates(message as MutationQueue));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static MutationQueue create() => MutationQueue._();
  MutationQueue createEmptyInstance() => create();
  static $pb.PbList<MutationQueue> createRepeated() =>
      $pb.PbList<MutationQueue>();
  @$core.pragma('dart2js:noInline')
  static MutationQueue getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MutationQueue>(create);
  static MutationQueue _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get lastAcknowledgedBatchId => $_getIZ(0);
  @$pb.TagNumber(1)
  set lastAcknowledgedBatchId($core.int v) {
    $_setSignedInt32(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set lastStreamToken($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
...
class WriteBatch extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WriteBatch',
      package: const $pb.PackageName('firestore.client'),
      createEmptyInstance: create)
  ...
  factory WriteBatch.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory WriteBatch.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  WriteBatch clone() => WriteBatch()..mergeFromMessage(this);
  WriteBatch copyWith(void Function(WriteBatch) updates) =>
      super.copyWith((message) => updates(message as WriteBatch));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static WriteBatch getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<WriteBatch>(create);
  ...
  @$pb.TagNumber(3)
  set localWriteTime($4.Timestamp v) {
    setField(3, v);
  }
