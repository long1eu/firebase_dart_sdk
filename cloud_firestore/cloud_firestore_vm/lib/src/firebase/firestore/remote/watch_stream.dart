...
import 'package:cloud_firestore_vm/src/firebase/firestore/remote/abstract_stream.dart';
...
class WatchStream extends AbstractStream<proto.ListenRequest, proto.ListenResponse, WatchStreamCallback> {
  ...
  void watchQuery(TargetData targetData) {
    ...
    final proto.ListenRequest request = proto.ListenRequest.create()
      ...
      ..addTarget = serializer.encodeTarget(targetData);

    final Map<String, String> labels = serializer.encodeListenRequestLabels(targetData);
    if (labels != null) {
