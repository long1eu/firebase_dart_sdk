...
/// [DocumentKey] (and a separate lookup must be done to read the document contents), since the
/// actual index entries may be lossy and should not be relied upon.
// TODO(long1eu): We could probably avoid one final document lookup for most
//  queries by exposing the (lossy) index entry, or at least the typeOrder for
//  it (since the type itself will never be lossy).
class IndexCursor {
