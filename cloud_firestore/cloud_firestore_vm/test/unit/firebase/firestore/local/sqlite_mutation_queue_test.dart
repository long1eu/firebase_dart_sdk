...
void main() {
  ...
  setUp(() async {
    ...
    final SQLitePersistence persistence = await openSQLitePersistence(
        'firebase/firestore/local/sqlite_mutation_queue_test-${Uuid().v4()}.db');
  ...
  test('testNextMutationBatchAfterBatchId',
      () => testCase.testNextMutationBatchAfterBatchId());
  test('testAllMutationBatchesAffectingDocumentKey',
      () => testCase.testAllMutationBatchesAffectingDocumentKey());
  test('testAllMutationBatchesAffectingDocumentKeys',
      () => testCase.testAllMutationBatchesAffectingDocumentKeys());
  test(
      'testAllMutationBatchesAffectingDocumentLotsOfDocumentKeys',
      () =>
          testCase.testAllMutationBatchesAffectingDocumentLotsOfDocumentKeys(),
      timeout: const Timeout(Duration(minutes: 2)));
  test('testAllMutationBatchesAffectingQuery',
      () => testCase.testAllMutationBatchesAffectingQuery());
