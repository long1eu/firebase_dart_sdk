...
Future<AuthResult> _signInWithEmailAndPassword(FirebaseAuthOption option) async {
  final EmailAndPassword result = await getEmailAndPassword(enableForgetPassword: true);
