...
class FirebaseAuthDart extends flutter.FirebaseCorePlatform {
  /// Registers that [FirebaseAuthDart] is the platform implementation.
  ///
  ...
  static Future<void> register({
    ...
    flutter.FirebaseCorePlatform.instance = FirebaseAuthDart();
  }
