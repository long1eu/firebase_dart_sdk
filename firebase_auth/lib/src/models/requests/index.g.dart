...
class _$CreateAuthUriRequestSerializer
  ...
  Iterable<Object> serialize(
    ...
    if (object.openidRealm != null) {
      result
        ..add('openidRealm')
        ..add(serializers.serialize(object.openidRealm,
            specifiedType: const FullType(String)));
    }
    ...
    if (object.otaApp != null) {
      result
        ..add('otaApp')
        ..add(serializers.serialize(object.otaApp,
            specifiedType: const FullType(String)));
    }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'continueUri':
          ...
          break;
        case 'openidRealm':
          result.openidRealm = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'providerId':
        ...
        case 'context':
          ...
          break;
        case 'otaApp':
          result.otaApp = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'appId':
...
class _$CreateAuthUriResponseSerializer
  ...
  Iterable<Object> serialize(
    ...
    if (object.authUri != null) {
      result
        ..add('authUri')
        ..add(serializers.serialize(object.authUri,
            specifiedType: const FullType(String)));
    }
    if (object.providerId != null) {
      result
    ...
    if (object.forExistingProvider != null) {
      result
        ..add('forExistingProvider')
        ..add(serializers.serialize(object.forExistingProvider,
            specifiedType: const FullType(bool)));
    }
    ...
    if (object.signInMethods != null) {
      result
        ..add('signinMethods')
        ..add(serializers.serialize(object.signInMethods,
            specifiedType:
                const FullType(BuiltList, const [const FullType(String)])));
    }
    return result;
  ...
  CreateAuthUriResponse deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'authUri':
          result.authUri = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'registered':
          result.registered = serializers.deserialize(value,
        ...
        case 'forExistingProvider':
          result.forExistingProvider = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'allProviders':
          ...
          break;
        case 'signinMethods':
          result.signInMethods.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(BuiltList, const [const FullType(String)]))
              as BuiltList<dynamic>);
          break;
  ...
  _$ActionCodeSettings._(
    ...
    if (canHandleCodeInApp == null) {
      throw new BuiltValueNullFieldError(
          'ActionCodeSettings', 'canHandleCodeInApp');
    }
  }
...
class _$BaseAuthRequest extends BaseAuthRequest {
  ...
  _$BaseAuthRequest._(
      {this.email, this.displayName, this.password, this.returnSecureToken})
      : super._() {
                    ...
                    $jc(
                        $jc(
                            $jc($jc(0, identifier.hashCode),
                                continueUri.hashCode),
                            openidRealm.hashCode),
                        providerId.hashCode),
                    clientId.hashCode),
                context.hashCode),
            otaApp.hashCode),
...
class CreateAuthUriRequestBuilder
  ...
  String _openidRealm;
  String get openidRealm => _$this._openidRealm;
  set openidRealm(String openidRealm) => _$this._openidRealm = openidRealm;
  ...
  String _otaApp;
  String get otaApp => _$this._otaApp;
  set otaApp(String otaApp) => _$this._otaApp = otaApp;
...
class _$CreateAuthUriResponse extends CreateAuthUriResponse {
  ...
  @override
  final BuiltList<String> signInMethods;
  ...
  bool operator ==(Object other) {
    ...
    return other is CreateAuthUriResponse &&
        ...
        registered == other.registered &&
        providerId == other.providerId &&
        forExistingProvider == other.forExistingProvider &&
        allProviders == other.allProviders &&
        signInMethods == other.signInMethods;
  }
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc(
                $jc($jc($jc(0, authUri.hashCode), registered.hashCode),
                    providerId.hashCode),
                forExistingProvider.hashCode),
  ...
  String toString() {
    return (newBuiltValueToStringHelper('CreateAuthUriResponse')
          ...
          ..add('registered', registered)
          ..add('providerId', providerId)
          ..add('forExistingProvider', forExistingProvider)
          ..add('allProviders', allProviders)
          ..add('signInMethods', signInMethods))
        .toString();
  }
}
...
class CreateAuthUriResponseBuilder
  ...
  String _authUri;
  String get authUri => _$this._authUri;
  set authUri(String authUri) => _$this._authUri = authUri;
  ...
  bool get forExistingProvider => _$this._forExistingProvider;
  set forExistingProvider(bool forExistingProvider) =>
      _$this._forExistingProvider = forExistingProvider;
  ...
  ListBuilder<String> _signInMethods;
  ListBuilder<String> get signInMethods =>
      _$this._signInMethods ??= new ListBuilder<String>();
  set signInMethods(ListBuilder<String> signInMethods) =>
      _$this._signInMethods = signInMethods;

  CreateAuthUriResponseBuilder();

  CreateAuthUriResponseBuilder get _$this {
    if (_$v != null) {
      _authUri = _$v.authUri;
      _registered = _$v.registered;
      _providerId = _$v.providerId;
      _forExistingProvider = _$v.forExistingProvider;
      _allProviders = _$v.allProviders?.toBuilder();
      _signInMethods = _$v.signInMethods?.toBuilder();
      _$v = null;
    }
    return this;
  }
    ...
    try {
      _$result = _$v ??
          new _$CreateAuthUriResponse._(
              ...
              allProviders: _allProviders?.build(),
              signInMethods: _signInMethods?.build());
    } catch (_) {
      String _$failedField;
      try {
        _$failedField = 'allProviders';
        _allProviders?.build();
        _$failedField = 'signInMethods';
        _signInMethods?.build();
      } catch (e) {
